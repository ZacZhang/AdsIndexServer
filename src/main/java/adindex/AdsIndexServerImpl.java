...
public class AdsIndexServerImpl extends AdsIndexGrpc.AdsIndexImplBase{
    ...
    @Override
    public void getAds(adindex.AdsRequest request,
                       io.grpc.stub.StreamObserver<adindex.AdsReply> responseObserver) {
        ...
        for(int i = 0; i < request.getQueryCount();i++) {
            ...
            List<Ad>  adsCandidates = AdsSelector.
                    getInstance(mMemcachedServer, mMemcachedPortal,mTFMemcachedPortal, mDFMemcachedPortal, mysql_host,
